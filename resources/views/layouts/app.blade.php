...
<body>
    ...
    <nav class="w3-sidebar w3-black w3-animate-top w3-xxlarge"
        style="display:none;padding-top:100px;z-index:4;color:white;" id="mySidebar">
        <a href="javascript:void(0)" onclick="w3_close()"
            class="w3-button w3-black w3-text-white w3-xxlarge w3-padding w3-display-topright"
            style="padding:6px 24px;color: white;">
            <i class="fa fa-remove"></i>
        </a>
        <div class="w3-bar-block w3-center" style="width: 30%; margin: auto;">
            <a style="text-decoration: none; color: white;" href="/"
                class="w3-bar-item w3-text-grey w3-hover-black">Home</a>
            <a style="text-decoration: none; color: white;" href="/"
                class="w3-bar-item w3-text-grey w3-hover-black">Games</a>
        </div>
    </nav>
    ...
    <div class="w3-top">
      ...
      <a href="#contact" class="w3-bar-item w3-button">Contact</a> -->
                <span style="cursor: pointer;" class="w3-right" onclick="w3_open()"><i
